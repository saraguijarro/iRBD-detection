...
#BSUB -R "span[hosts=1]"
#BSUB -W 2:00
#BSUB -o /work3/s184484/iRBD-detection/jobs/logs/ml/ml_v0_%J.out
#BSUB -e /work3/s184484/iRBD-detection/jobs/logs/ml/ml_v0_%J.err
#BSUB -N

# ML BASELINES JOB SCRIPT FOR iRBD DETECTION PIPELINE - VERSION V0
...
mkdir -p results/ml_baselines_v0
...
echo "Executing: python scripts/ml_baselines.py --version v0"
python scripts/ml_baselines.py --version v0
...
# Check for output files in results/ml_baselines_v0
if [ -d "results/ml_baselines_v0" ]; then
    ML_COUNT=$(find results/ml_baselines_v0 -type f 2>/dev/null | wc -l)
