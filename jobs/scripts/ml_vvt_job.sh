...
#BSUB -R "span[hosts=1]"
#BSUB -W 2:00
#BSUB -o /work3/s184484/iRBD-detection/jobs/logs/ml/ml_vvt_%J.out
#BSUB -e /work3/s184484/iRBD-detection/jobs/logs/ml/ml_vvt_%J.err
#BSUB -N

# ML BASELINES JOB SCRIPT FOR iRBD DETECTION PIPELINE - VERSION vvt
...
mkdir -p results/ml_baselines_vvt
...
echo "Executing: python scripts/ml_baselines.py --version vvt"
python scripts/ml_baselines.py --version vvt
...
# Check for output files in results/ml_baselines_vvt
if [ -d "results/ml_baselines_vvt" ]; then
    ML_COUNT=$(find results/ml_baselines_vvt -type f 2>/dev/null | wc -l)
