...
# VERSION 1: TEMPERATURE FILTERING - 18°C threshold with rate-of-change detection (DETACH)
...
echo "TEMPERATURE FILTERING (18°C + DETACH)"
echo "=========================================="
...
# =============================================================================
echo "Starting preprocessing v1 pipeline (WITH TEMPERATURE FILTERING - 18°C + DETACH)..."
echo "Timestamp: $(date)"
...
echo "=========================================="
echo "Version: v1 (WITH TEMPERATURE FILTERING - 18°C + DETACH)"
echo "Job ID: $LSB_JOBID"
