...
#BSUB -R "span[hosts=1]"
#BSUB -W 2:00
#BSUB -o /work3/s184484/iRBD-detection/jobs/logs/ml/ml_v1t_%J.out
#BSUB -e /work3/s184484/iRBD-detection/jobs/logs/ml/ml_v1t_%J.err
#BSUB -N

# ML BASELINES JOB SCRIPT FOR iRBD DETECTION PIPELINE - VERSION V1t
...
mkdir -p results/ml_baselines_v1t
...
echo "Executing: python scripts/ml_baselines.py --version v1t"
python scripts/ml_baselines.py --version v1t
...
# Check for output files in results/ml_baselines_v1t
if [ -d "results/ml_baselines_v1t" ]; then
    ML_COUNT=$(find results/ml_baselines_v1t -type f 2>/dev/null | wc -l)
