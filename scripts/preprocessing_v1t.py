...
# PREPROCESSING V1T - TEMPERATURE FILTERING
# Transform raw accelerometer files into clean night-segmented data suitable for feature extraction.
# V1T: Adds rate-of-change temperature detection (20°C) to baseline (v0)
...
# 3. Quality control : 
#    - Apply 20°C temperature threshold with rate-of-change detection (DETACH algorithm)
...
# Directories : 
#    - /work3/s184484/iRBD-detection/data/preprocessed_v1t/controls/
#    - /work3/s184484/iRBD-detection/data/preprocessed_v1t/irbd/
...
# Temperature Threshold : 20 degrees Celcius (iRBD literature standard)
...
class PreprocessingPipeline:
    ...
    def __init__(self):
        ...
        # Output directories
        self.preprocessed_controls_dir = self.base_dir / "data" / "preprocessed_v1t" / "controls"  # Processed healthy data
        self.preprocessed_irbd_dir = self.base_dir / "data" / "preprocessed_v1t" / "irbd"          # Processed iRBD data

        # Visualization output directory
        self.plots_dir = self.base_dir / "results" / "visualizations" / "v1t"
        ...
        self.temp_threshold = 20.0              # Temperature threshold in Celsius
    ...
    def setup_logging(self):
        ...
        log_file = self.log_dir / f"preprocessing_v1t_{current_time}.log"
    ...
    def detect_nonwear_rate_of_change(self, data, temp_threshold=20.0, window_minutes=5):
        """
        ...
        Args:
            ...
            temp_threshold: Temperature threshold in Celsius (default 20°C)
    ...
    def apply_temperature_filtering(self, data):
        ...
        V1T: Uses DETACH algorithm with 20°C threshold and rate-of-change detection.
        ...
        3. Removes only periods with rapid cooling below 20°C
