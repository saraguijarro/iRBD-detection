...
#    - Apply per-night temperature filtering (avg temp >= 20°C)
...
# Directories : 
#    - /work3/s184484/iRBD-detection/data/preprocessed_vvt/controls/
#    - /work3/s184484/iRBD-detection/data/preprocessed_vvt/irbd/ 
...
# Temperature Threshold : 20°C per-night average
...
## HPC JOB EXECUTION
# Job script : preprocessing_vvt_job.sh
# Location : /work3/s184484/iRBD-detection/jobs/scripts/preprocessing_vvt_job.sh
# Queue : hpc (CPU nodes)
# Resources : 4 cores, 8GB RAM per core
# Time limit : 24 hours
# Output logs : /work3/s184484/iRBD-detection/jobs/logs/prep_vvt/prep_vvt_output_JOBID.out
# Error logs : /work3/s184484/iRBD-detection/jobs/logs/prep_vvt/prep_vvt_error_JOBID.err
...
class PreprocessingPipeline:
    ...
    VERSION VVT:
    - Per-night temperature filtering (20°C average threshold)
    ...
    - Purpose: Implement Brink's three rules of exclusion and per night filtering methodology
    - Saves to preprocessed_vvt/ directory
    """
    ...
    def __init__(self):
        ...
        #self.raw_example_file = self.base_dir / "data" / "raw" / f"{self.example_participant}.cwa"

        # Output directories
        self.preprocessed_controls_dir = self.base_dir / "data" / "preprocessed_vvt" / "controls"  # Processed healthy data
        self.preprocessed_irbd_dir = self.base_dir / "data" / "preprocessed_vvt" / "irbd"          # Processed iRBD data

        # Visualization output directory
        self.plots_dir = self.base_dir / "results" / "visualizations" / "vvt"
        ...
        # VVT: Per-night temperature threshold
        self.temp_threshold = 20.0              # Temperature threshold in Celsius (per-night average)
        ...
        print(f"Temperature threshold: {self.temp_threshold}°C (per-night average)")
    ...
    def initialize_stats(self):
        ...
        self.stats = {
            ...
            'nights_rejected_temperature': 0, # Nights rejected: avg temp < 20°C
    ...
    def setup_logging(self):
        ...
        log_file = self.log_dir / f"preprocessing_vvt_{current_time}.log"
        ...
        self.logger.info(f"=== Preprocessing Pipeline VVT Started ({self.mode}) ===")
        self.logger.info(f"Base directory: {self.base_dir}")
        self.logger.info(f"Temperature threshold: {self.temp_threshold}°C (per-night average)")
    ...
    def validate_night(self, night_data):
        ...
        2. Average temperature must be >= 20°C
        ...
        # Rule 2: Average temperature must be >= 20°C
    ...
    def save_preprocessed_data(self, nights_data, participant_id, output_path):
        ...
        try:
            ...
            with h5py.File(output_path, 'w') as f:
                ...
                # Save each night's data as a separate group in the file
                # IMPORTANT: Renumber nights consecutively starting from 1
                for new_night_num, night_info in enumerate(nights_data, start=1):
                    night_data = night_info['data']
                    
                    # Create a group for this night (like a folder within the file)
                    night_group = f.create_group(f"night{new_night_num}")
        ...
        try:
            with h5py.File(h5_file, 'r') as f:
                ...
                for night_num in range(1, num_nights + 1):
                    ...
                    # Verify that night group has NO metadata
    ...
    def process_participant(self, cwa_file, group_type):
        ...
        try:
            ...
            # STEP 4: Apply per-night quality filtering
