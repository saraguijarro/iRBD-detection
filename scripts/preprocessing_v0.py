...
## VERSION 0 (BASELINE):
# NO temperature filtering (baseline control)
# Uses ONLY actipy's built-in non-wear detection
# Fixed 22:00-06:00 time windows (8-hour sleep periods)
# Purpose: Baseline preprocessing
...
# 3. Quality control : 
#    - Remove nights flagged as non-wear by actipy (NO temperature filtering)
...
# Directories : 
#    - /work3/s184484/iRBD-detection/data/preprocessed_v0/controls/
#    - /work3/s184484/iRBD-detection/data/preprocessed_v0/irbd/ 
...
# Temperature Threshold : NONE (removed to test impact on exclusion rate)
# Non-wear Detection : Automatic flagging by actipy only
...
## HPC JOB EXECUTION
# Job script : preprocessing_v0_job.sh
# Location : /work3/s184484/iRBD-detection/jobs/scripts/preprocessing_v0_job.sh
# Queue : hpc (CPU nodes)
# Resources : 4 cores, 8GB RAM per core
# Time limit : 24 hours
# Output logs : /work3/s184484/iRBD-detection/jobs/logs/prep_v0/prep_v0_output_JOBID.out
# Error logs : /work3/s184484/iRBD-detection/jobs/logs/prep_v0/prep_v0_error_JOBID.err
...
class PreprocessingPipeline:
    ...
    def __init__(self):
        ...
        # Output directories
        self.preprocessed_controls_dir = self.base_dir / "data" / "preprocessed_v0" / "controls"  # Processed healthy data
        self.preprocessed_irbd_dir = self.base_dir / "data" / "preprocessed_v0" / "irbd"          # Processed iRBD data

        # Visualization output directory
        self.plots_dir = self.base_dir / "results" / "visualizations" / "v0"
        ...
        print(f"Temperature threshold: NONE (v0 - testing exclusion impact)")
    ...
    def setup_logging(self):
        ...
        log_file = self.log_dir / f"preprocessing_v0_{current_time}.log"
        ...
        self.logger.info(f"=== Preprocessing Pipeline v0 Started ({self.mode}) ===")
        self.logger.info(f"Base directory: {self.base_dir}")
        self.logger.info(f"Temperature threshold: NONE (v0 - testing exclusion impact)")
    ...
    def apply_nonwear_filtering(self, data):
        """
        v0: Remove only actipy-flagged non-wear periods.
        ...
        self.logger.info(f" Applying non-wear filtering (actipy only, NO temperature threshold)")
        ...
        # Apply only the actipy non-wear filter
    ...
    def segment_nights(self, data):
        ...
        # Add timestamps as a column for easier access
